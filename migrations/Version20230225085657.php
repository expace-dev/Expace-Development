 ...
 */
final class Version20230225085657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paiements (id INT AUTO_INCREMENT NOT NULL, facture_id INT NOT NULL, client_id INT NOT NULL, montant VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_E1B02E127F2DEE08 (facture_id), INDEX IDX_E1B02E1219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
