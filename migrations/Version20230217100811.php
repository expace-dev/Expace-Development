 ...
 */
final class Version20230217100811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE portfolios (id INT AUTO_INCREMENT NOT NULL, client VARCHAR(255) NOT NULL, date DATETIME NOT NULL, url VARCHAR(255) NOT NULL, details LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
